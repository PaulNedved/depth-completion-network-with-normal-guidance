...
/mnt/sdb6/kbnet/trained_kbnet/kitti_0/kbnet_model/depth_model-250000.pth \
--output_path \
/mnt/sdb6/kbnet/evaluation/evaluation_results_ori_250000 \
--device gpu \
--save_outputs 