...
/home/mvl/KBNet/calibrated-backprojection-network-master/trained_kbnet/kitti_230220/kbnet_model/depth_model-170000.pth \
--output_path \
evaluation/evaluation_result_new_205000_202404_test \
--device gpu \
--save_outputs
