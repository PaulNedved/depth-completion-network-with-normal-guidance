...
python src_for_ablation/train_kbnet.py \
...
--checkpoint_path trained_kbnet/kitti_ablation/kbnet_model \
--device gpu \
--n_thread 8 \
--depth_model_restore_path trained_kbnet/kitti_ablation/kbnet_model/depth_model-220000.pth \
--pose_model_restore_path trained_kbnet/kitti_ablation/kbnet_model/pose_model-220000.pth \
--start_step 220000