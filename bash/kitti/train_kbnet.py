...
parser.add_argument('--val_image_path',
    type=str, default='', help='Path to list of validation image paths')  #验证集
...
parser.add_argument('--start_step',
    type=int, default=0, help='choice the start_step')
...
if __name__ == '__main__':
    ...
    # Weight settings
    args.weight_initializer = args.weight_initializer.lower()  # xavier_normal

    args.activation_func = args.activation_func.lower()  # lower()函数：将大写均转换为小写
