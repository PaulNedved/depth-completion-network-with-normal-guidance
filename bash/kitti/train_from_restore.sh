...
--checkpoint_path trained_kbnet/kitti_221009/kbnet_model \
--device gpu \
--n_thread 8 \
--depth_model_restore_path trained_kbnet/kitti_221009/kbnet_model/depth_model-295000.pth \
--pose_model_restore_path trained_kbnet/kitti_221009/kbnet_model/pose_model-295000.pth \
--start_step 295000