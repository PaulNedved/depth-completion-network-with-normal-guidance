...
--dense_normal_path validation/kitti/kitti_val_dense_normal.txt \
...
/home/mvl/KBNet/calibrated-backprojection-network-master/trained_kbnet/kitti_221009/kbnet_model/depth_model-300000.pth \
--output_path \
/mnt/sdb6/kbnet/evaluation/evaluation_result_new_300000 \
--device gpu
#--save_outputs \
