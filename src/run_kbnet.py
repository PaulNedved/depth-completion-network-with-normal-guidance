...
parser.add_argument('--dense_normal_path',
    type=str, required=True, help='Path to list of dense normal paths')
...
if __name__ == '__main__':
    ...
    print('save output or not:', args.save_outputs)
